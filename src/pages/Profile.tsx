            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold">
                  {roadmaps.length > 0 ? Math.round(roadmaps.reduce((sum, r) => sum + (r.progress || 0), 0) / roadmaps.length) : 0}%
                </span>
              </div>
              <div className="flex justify-between items-center">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form onSubmit={handleEmailChange} className="space-y-3 mb-6">
              ...
              <div className="flex items-center">
                ...
                <button type="submit" className="px-4 py-2 bg-gray-100 text-gray-700 rounded-r-lg hover:bg-gray-200 font-medium text-sm">Save</button>
              </div>
            </form>
            ...
            <form onSubmit={handlePasswordChange} className="space-y-3">
              ...
              <button type="submit" className="w-full text-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium text-sm">Update Password</button>
            </form>
          </div>
